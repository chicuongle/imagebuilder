# Introduction
Building image for general Golang development
## Commands

```bash
docker build . -t echipdockerhub/baseworkspace:golang-1.1.0 --build-arg="user=cle"
```

## Source for Gotools
[goTools from vscode](https://github.com/golang/vscode-go/blob/master/extension/src/goToolsInformation.ts)
```javascript
